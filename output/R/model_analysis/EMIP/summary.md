...
1. Dominant role of individual differences
   ...
   - This indicates stable, idiosyncratic visual strategies that persist across pairings and conditions.
   - This pattern appears in:
     - Between-group expertise mean/difference models
...
4. Trial effects (within-group, Trial 2 vs Trial 5)
   ...
   - These effects are small but statistically reliable, indicating that task progression or trial context can modulate similarity independently of expertise.

## Overall interpretation

- MultiMatch scanpath similarity primarily reflects who the programmer is, not how expert they are.
- Expertise does not induce convergence or divergence in visual strategies under these metrics.
- Some dimensions (Direction, Position) remain highly context-dependent, while others (Shape, Length) capture stable individual visual signatures.
- Trial-level changes matter more than expertise, but even these effects are modest relative to individual differences.
